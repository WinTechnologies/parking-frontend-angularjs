...
@Component({
  selector: 'app-exception-new',
  templateUrl: './exception-new.component.html',
  styleUrls: ['./exception-new.component.scss']
})

export class ExceptionNewComponent implements OnInit, OnChanges {
