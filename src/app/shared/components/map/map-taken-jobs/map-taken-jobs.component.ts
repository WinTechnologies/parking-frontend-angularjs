...
@Component({
  selector: 'app-map-taken-jobs',
  templateUrl: './map-taken-jobs.component.html',
  styleUrls: ['../map.component.scss', './map-taken-jobs.component.scss']
})
export class MapTakenJobsComponent implements OnInit, OnDestroy {
