...
@Component({
  selector: 'app-map-intensity',
  templateUrl: './map-intensity.component.html',
  styleUrls: ['../map.component.scss', './map-intensity.component.scss']
})
export class MapIntensityComponent implements OnInit, OnDestroy {
