...
export class LayoutService {
  ...
  setAppLayout() {
    ...
    this.layoutConf = {
      ...
      "sidebarColor": "mawgif",      // http://demos.ui-lib.com/egret-doc/#egret-colors
      "sidebarCompactToggle": false, // applied when "sidebarStyle" is "compact"
      "dir": "ltr",                 // ltr, rtl
      "useBreadcrumb": true,
      "topbarFixed": true,
      "topbarColor": "mawgif",       // http://demos.ui-lib.com/egret-doc/#egret-colors
      "matTheme": "egret-mawgif",     // egret-blue, egret-navy, egret-dark-purple, egret-dark-pink
